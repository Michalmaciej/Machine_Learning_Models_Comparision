...
#creating KNN model and fitting
...
with open(os.path.join(os.path.dirname(__file__), "results.txt"), "a") as f:
    f.write(f"KNN_fromsklearn.py (k={model.n_neighbors}, weights={model.weights}): Accuracy={acc:.2f}, Precision={prec:.2f}, Recall={rec:.2f}, F1={f1:.2f}\n")