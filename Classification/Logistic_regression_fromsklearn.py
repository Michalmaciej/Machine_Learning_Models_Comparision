...
model = LogisticRegression(max_iter=10000, solver="saga", C=6.0)
...
with open(os.path.join(os.path.dirname(__file__), "results.txt"), "a") as f:
    f.write(f"Logistic_regression_fromsklearn.py: Accuracy={acc:.2f}, Precision={prec:.2f}, Recall={rec:.2f}, F1={f1:.2f}\n")