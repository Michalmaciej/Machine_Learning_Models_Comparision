...
#creating MLP model and fitting
model = MLPClassifier(
...
with open(os.path.join(os.path.dirname(__file__), "results.txt"), "a") as f:
    f.write(f"MLP_fromsklearn.py (layers={model.hidden_layer_sizes}, activation={model.activation}): Accuracy={acc:.2f}, Precision={prec:.2f}, Recall={rec:.2f}, F1={f1:.2f}\n")